...
def make_parser():
    ...
    parser.add_argument("--fast-reid-weights", dest="fast_reid_weights", default=r"/mnt/sda4/NamND/BoT-SORT/logs/MOT17/sbs_S50/model_final.pth", type=str,help="reid config file path")
